...
export const VentaForm = ({ open, onClose, onSubmit, clientes, productos }) => {
      ...
      <form onSubmit={handleSubmit}>
        <DialogContent sx={{ pt: 3 }}>
          <Box display="flex" flexDirection="column" gap={2.2}>
            <TextField label="Cliente" name="cliente_id" select value={formData.cliente_id} onChange={handleChange} required fullWidth>
        ...
        <DialogActions sx={{ px: 3, pb: 3, gap: 1 }}>
          ...
          <Button type="submit" variant="contained" sx={{ borderRadius: 2 }}>Guardar venta</Button>
        </DialogActions>
      </form>
    </Dialog>
  );
